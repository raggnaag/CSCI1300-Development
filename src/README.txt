...
About:
This application is a clean and application to buy and sell boats online.
...
flex box system we have used in class. The grid is responsive and "flexes:
based on browser. In addition I am using a universal typeface, it enforces one 
...
from my app.js class.
There is also another component, List which takes care of the sorting based on
price. This component is being passed on in FilteredList, which now makes
it possible to sort a filtered list.
